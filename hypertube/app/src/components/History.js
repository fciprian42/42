...
class History extends Component
{
    componentDidMount()
    {
        ...
        if (currentLanguage && currentLanguage === "en")
            document.title = "Hypertube - My last movies";
        else
            document.title = "Hypertube - Mes derniers films regardés";
        ...
        else
        {
            ...
            {
                dispatch(usersActions.getHistory());
                this.getAvatar();
            }
        }
    }
    ...
    render()
    {
        ...
        const emptyMovies = (
            <div>
                <h2>
                    <Translate id="favoritesMoviesEmpty" />
                </h2>
            </div>
        );
        ...
        const emptySeries = (
            <div>
                <h2>
                    <Translate id="favoritesSeriesEmpty" />
                </h2>
            </div>
        );
                    ...
                    <div className="history">
                        ...
                        <div className="movies-section" id="history-list" style={{marginTop: 0}}>
                            ...
                            <div className="movies-list" id="movies-list">
                                {this.props.users.history_movies && this.props.users.history_movies.length > 0 ? this.props.users.history_movies.map((value, key) => {
                            ...
                            <div className="movies-list" id="movies-list">
                                {this.props.users.history_series && this.props.users.history_series.length > 0 ? this.props.users.history_series.map((value, key) => {
